...
| [`dev-specs`](./.agents/skills/dev-specs/SKILL.md) | `.agents/skills/dev-specs/` | Templates Markdown reutilizables para especificaciones de desarrollo; incluye una plantilla de functional specification document para estandarizar alcance, requisitos y criterios de aceptacion | `npx skills add https://github.com/rcrespo-tripulse/tripulse-skills --skill dev-specs` |
